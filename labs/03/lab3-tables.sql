...
-- Sat 05 Oct 2019 10:53:34 PM CDT
...
CREATE TABLE IF NOT EXISTS `customer` (
  `id` INT NOT NULL,
  `rentalCard_id` INT NULL DEFAULT NULL,
  `preferredMovieStore_id` INT NULL DEFAULT NULL,
  ...
  INDEX `fk_customer_rentalCard1_idx` (`rentalCard_id` ASC) VISIBLE,
  INDEX `fk_customer_movieStore1_idx` (`preferredMovieStore_id` ASC) VISIBLE,
  INDEX `fk_customer_genre1_idx` (`preferred_genre_id_1` ASC) VISIBLE,
  INDEX `fk_customer_genre2_idx` (`preferred_genre_id_2` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `movieRentalEvent` (
  ...
  INDEX `fk_rentalEvent_movie_idx` (`movie_id` ASC) VISIBLE,
  INDEX `fk_rentalEvent_rentalCard1_idx` (`rentalCard_id` ASC) VISIBLE,
  INDEX `fk_rentalEvent_movieStore1_idx` (`movieStore_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `productPurchaseEvent` (
  ...
  INDEX `fk_productPurchaseEvent_movieStore1_idx` (`movieStore_id` ASC) VISIBLE,
  INDEX `fk_productPurchaseEvent_rentalCard1_idx` (`rentalCard_id` ASC) VISIBLE,
  INDEX `fk_productPurchaseEvent_product1_idx` (`product_id` ASC) VISIBLE,
